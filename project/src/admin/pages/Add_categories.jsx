                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-heading text-center mb-sm-5 mb-4">
                                <h3 className="title-style mb-5">Add Categories</h3>
                                <p className="lead">
                        ...
                        <div className="row mt-5 mb-5">
                            <div className="offset-lg-3 col-lg-6 offset-md-3 col-md-6">
                                ...
                                <form action="" method='post'>
                                    ...
                                    <div className="mb-3 mt-3">
                                        <label htmlFor="email" className="form-label">Categories Image:</label>
                                        <input type="url" className="form-control" id="email" placeholder="Enter Categories Image URL" name="cate_img" />
                                    </div>
